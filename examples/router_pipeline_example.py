...
def main():
    ...
    # TextGeneratorSnap ------> RouterSnap ------> TextLengthSnap
    #                                      ------> TextUppercaseSnap
    pipeline = Pipeline()
    ...
    text_generator_snap = TextGeneratorSnap(text="Hello this is a long sentence")
    ...
    pipeline.connect(text_generator_snap, "text", router_snap, "input")
